  ...
  steps:[
    ...
    { say:"<b>Beat vs. Division:</b> 6/8 contains six eighth notes, but at normal tempos it has only <b>TWO beats</b> — each a <b>dotted quarter</b>. The six eighth notes are the <b>divisions</b> of those two beats. The bottom number names the division note, not the beat. \u{1F447} <b>In 6/8 at a normal tempo, which note gets the beat?</b>",
      ...
      try:{ type:"mc", choices:["The dotted quarter note","The eighth note","The whole note"], answer:0,
        ...
        hint:"♪+♪+♪ = ♩." } },
    { say:"<b>The Three Compound Meters:</b> <b style='color:#2F6DA8'>6/8 = compound DUPLE</b> (2 beats) · <b style='color:#C05A21'>9/8 = compound TRIPLE</b> (3 beats) · <b style='color:#A9821F'>12/8 = compound QUADRUPLE</b> (4 beats). <b>Remember: beats = top number ÷ 3.</b> \u{1F447} <b>How many beats does 9/8 have?</b>",
      show:{ type:"html", html:`<table style="border-collapse:collapse;margin:0 auto;font-size:14.5px;min-width:300px">
        ...
        <tr><td style="border:1.5px solid #cdd5e1;padding:4px 14px;text-align:center;font-weight:800;color:#2F6DA8">6/8</td><td style="border:1.5px solid #cdd5e1;padding:4px 14px;text-align:center">6 ÷ 3 = 2</td><td style="border:1.5px solid #cdd5e1;padding:4px 14px;text-align:center;color:#2F6DA8;font-weight:800">Compound Duple</td></tr>
        ...
        <tr><td style="border:1.5px solid #cdd5e1;padding:4px 14px;text-align:center;font-weight:800;color:#A9821F">12/8</td><td style="border:1.5px solid #cdd5e1;padding:4px 14px;text-align:center">12 ÷ 3 = 4</td><td style="border:1.5px solid #cdd5e1;padding:4px 14px;text-align:center;color:#A9821F;font-weight:800">Compound Quadruple</td></tr></table>` },
