...
LESSON_CONTENT[28]={
  ...
  steps:[
    ...
    { say:"Scale detective again. Read the accidentals carefully. \u{1F447} <b>Which major scale is this?</b>",
  ...
  quiz:[
    ...
    { type:"truefalse", q:"Every major scale follows the same interval pattern.", answer:true,
      explain:"W–W–H–W–W–W–H — flats exist to preserve it.", hint:"Same blueprint as always." },
    { type:"truefalse", q:"F major contains two flats.", answer:false,
  ...
  mia:{
    ...
    learn:{ label:"the flat scales",
      explain:"Same blueprint, flat repairs: F major needs B♭; B♭ major needs B♭ and E♭. Flats are chosen (not sharps) to keep the letters alphabetical.",
