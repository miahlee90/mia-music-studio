/* Lesson 107 — Modal Mixture and Borrowed Chords (Book 4, Unit 26 — SELF-AUTHORED)
...
function MF_L107_prog(container,fb,cfg){
...
function MF_L107_compare(container,fb,cfg){
...
function MF_L107_panel(host){
  ...
  host.querySelector("#l107c").onclick=()=>seq([[55,59,62],[60,64,67]]);
  const fbd=host.querySelector("#l107pfb");
  [...host.querySelectorAll("#l107pch button")].forEach((b,i)=>b.onclick=()=>{
    if(i===0){ fbd.textContent="✓ Correct. The Picardy ending starts in C minor and closes on a major C tonic."; fbd.style.color="#2e7d32"; }
...
LESSON_CONTENT[107]={
  ...
  steps:[
    ...
    { say:"<b>Borrowed Chords in a Progression:</b> In C major, ♭VI and ♭VII may rise by whole step to the tonic. This borrowed-chord progression is common in rock, film, and game music, where it is sometimes informally called the \u{201C}Mario cadence.\u{201D} \u{1F447} <b>From which parallel mode are ♭VI and ♭VII borrowed in C major?</b>",
      try:{ type:"custom", mount:(c,fb)=>MF_L107_prog(c,fb,{
        heading:"Key: C major",
    ...
    { say:"<b>Hear the Picardy Third:</b> Compare an ordinary minor ending with a Picardy ending in C minor. Only the third of the last chord changes — E♭ rises to E♮. \u{1F447} <b>What changes in the Picardy ending?</b>",
      try:{ type:"custom", mount:(c,fb)=>MF_L107_compare(c,fb,{
        heading:"Key: C minor (B♭, E♭, A♭)",
        staffA:{clef:"grand",keysig:"Eb",time:"4/4",tempo:96,notes:[
          {p:"G3",d:"w",clef:"bass",label:"V"},{p:"B3",d:"w",chord:true,clef:"bass",acc:"n"},{p:"D4",d:"w",chord:true},{bar:"single"},
          {p:"C4",d:"w",label:"i"},{p:"Eb4",d:"w",chord:true,acc:"none"},{p:"G4",d:"w",chord:true},{bar:"final"}],width:260},
        staffB:{clef:"grand",keysig:"Eb",time:"4/4",tempo:96,notes:[
          {p:"G3",d:"w",clef:"bass",label:"V"},{p:"B3",d:"w",chord:true,clef:"bass",acc:"n"},{p:"D4",d:"w",chord:true},{bar:"single"},
          {p:"C4",d:"w",label:"I"},{p:"E4",d:"w",chord:true,acc:"n"},{p:"G4",d:"w",chord:true},{bar:"final"}],width:260},
        labelA:"▶ Play the minor ending", labelB:"▶ Play the Picardy ending",
        choices:["The tonic chord's third rises from E♭ to E♮","The tonic changes from C to G","The meter changes"], answer:0,
        ok:"✓ Correct. Raising E♭ to E♮ changes the final C-minor tonic into C major.",
        no:"Listen to the last chord of each: only its third differs (E♭ vs E♮)." }) } },
