...
LESSON_CONTENT[24]={
  ...
  steps:[
    { say:"The <b>natural (♮)</b> <b>cancels</b> a previous sharp or flat and returns the note to its <b>original pitch</b> — the plain white-key note. It's the accidental family's <b>undo button</b>. \u{1F447}",
      ...
      try:{ type:"mc",
        ...
        hint:"\u{1F504} undo." } },
    { say:"Why do we need it? Because of the <b>one-measure rule</b>! Once F♯ appears, every F stays sharp until the bar line — <b>unless a natural steps in</b>. \u{1F447}",
    ...
    { say:"One more look at the whole system: accidentals last <b>until the bar line</b>, naturals included. \u{1F447}",
      try:{ type:"mc",
