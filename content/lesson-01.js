...
LESSON_CONTENT[1]={
  ...
  vocabulary:[
    {term:"Staff", def:"5 lines and 4 spaces where music symbols live"},
    {term:"Line", def:"One of 5 horizontal lines, numbered from the bottom"},
    {term:"Space", def:"One of 4 gaps between lines, numbered from the bottom"},
    {term:"Note", def:"The symbol that represents one musical sound"},
