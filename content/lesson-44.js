...
LESSON_CONTENT[44]={
  ...
  steps:[
    { say:"Recall Lesson 42: fast 4/4 gets recounted as cut time — two big beats instead of four. The book applies the SAME idea here: fast 3/8 and 6/8 keep their signatures, but musicians <b>count only the strong beats</b>. \u{1F447} <b>Why count fewer beats at speed?</b>",
  ...
  practice:[
    ...
    { type:"mc", q:"At fast tempos, 3/8 is counted…", choices:["in one","in three","in six"], answer:0,
      explain:"One pulse per measure (AEMT p.69)." },
    ...
    { type:"mc", q:"In fast 6/8, a half-note rest… wait — which rest fills a WHOLE fast 6/8 measure?", choices:["the whole rest (2 counts)","the eighth rest","the quarter rest"], answer:0,
  ...
  quiz:[
    ...
    { type:"mc", q:"There is a strong beat on ____ in 3/8 time.", choices:["1","2","3","every beat"], answer:0,
      explain:"One bundle, one strong beat (AEMT p.69).", hint:"Where the measure launches." },
