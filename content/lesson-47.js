  ...
  steps:[
    ...
    { say:"Triads grow on <b>every</b> note of the scale. Here are all the root-position triads of C major — one per scale note, C through C. Press play and hear the whole neighborhood. \u{1F447} <b>How many different triads live in one octave of a major scale?</b>",
      show:{ type:"staff", spec:{clef:"treble",tempo:80,notes:[
        ...
        {p:"D4",d:"h",label:"D"},{p:"F4",d:"h",chord:true},{p:"A4",d:"h",chord:true},
        {p:"E4",d:"h",label:"E"},{p:"G4",d:"h",chord:true},{p:"B4",d:"h",chord:true},
        {p:"F4",d:"h",label:"F"},{p:"A4",d:"h",chord:true},{p:"C5",d:"h",chord:true},
        {p:"G4",d:"h",label:"G"},{p:"B4",d:"h",chord:true},{p:"D5",d:"h",chord:true},
        {p:"A4",d:"h",label:"A"},{p:"C5",d:"h",chord:true},{p:"E5",d:"h",chord:true},
        {p:"B4",d:"h",label:"B"},{p:"D5",d:"h",chord:true},{p:"F5",d:"h",chord:true}],width:640} },
