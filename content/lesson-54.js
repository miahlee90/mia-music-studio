  ...
  Keyboard.create(kh,{start:60,octaves:2,labels:true,
    onKey:m=>{
      ...
      if(m%12===want && (last===null || m>last)){
        ...
        if(k>=R.pcs.length){ MFAudio.yay(); got.forEach(x=>MFAudio.tone(x,1.0,.15,.3));
  ...
  examples:[
    ...
    { caption:"The seventh-chord figures in action: V⁷ → V⁶₅ → V⁴₃ → V⁴₂ — then the 4/2 bass (the 7th, F) sinks by step into I⁶. Figured bass tells this whole story in six tiny labels.",
      staff:{clef:"treble",tempo:70,notes:[
        {p:"G3",d:"h",label:"V⁷"},{p:"B3",d:"h",chord:true},{p:"D4",d:"h",chord:true},{p:"F4",d:"h",chord:true},
        {p:"B3",d:"h",label:"V⁶₅"},{p:"D4",d:"h",chord:true},{p:"F4",d:"h",chord:true},{p:"G4",d:"h",chord:true},
        {p:"D4",d:"h",label:"V⁴₃"},{p:"F4",d:"h",chord:true},{p:"G4",d:"h",chord:true},{p:"B4",d:"h",chord:true},
        {p:"F4",d:"h",label:"V⁴₂"},{p:"G4",d:"h",chord:true},{p:"B4",d:"h",chord:true},{p:"D5",d:"h",chord:true},
