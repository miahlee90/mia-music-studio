...
LESSON_CONTENT[37]={
  ...
  vocabulary:[
    ...
    {term:"Double Sharp (𝄪)", def:"Raises an already-sharp note by another half step — used to spell augmented intervals correctly."},
    {term:"Double Flat (𝄫)", def:"Lowers an already-flat note by another half step — used to spell diminished intervals correctly."},
