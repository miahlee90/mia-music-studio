...
LESSON_CONTENT[69]={
  ...
  games:[
    ...
    { type:"key-climb", title:"Game 2 · Play a Model Phrase",
      intro:"Perform a labeled minor phrase: R-R-5-5-L-5 in D minor!",
  ...
  practice:[
    ...
    { type:"truefalse", q:"Should the raised 7th be avoided in a minor melody? (True = avoid it)", answer:false,
