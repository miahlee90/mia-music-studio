...
LESSON_CONTENT[9]={
  ...
  vocabulary:[
    {term:"Rest", def:"A symbol for musical silence"},
    {term:"Whole Rest", def:"Hangs down from the 4th line — 4 beats (the hole)"},
    {term:"Half Rest", def:"Sits on the 3rd line — 2 beats (the hat)"},
